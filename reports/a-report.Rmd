...
```{r}
parlamentares_x_partidos
```

### 1.3. Os partidos com mais tweets são aqueles que possuem parlamentares mais populares?
Utilizando o engajamento total para definir os parlamentares mais populares, temos:
